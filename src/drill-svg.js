  ...
  return `
    ...
    <g clip-path="url(#ice)">
      <g stroke-linecap="round">
        ...
        <path d="M 17 36.5 A 6 6 0 0 1 17 48.5" fill="#a3d0ee" stroke="${mk}" stroke-width="0.35" opacity="0.9"/>
        <path d="M 183 36.5 A 6 6 0 0 0 183 48.5" fill="#a3d0ee" stroke="${mk}" stroke-width="0.35" opacity="0.9"/>
      </g>
