...
export function RinkMarkings({ yFix = 1 }) {
  ...
  return (
    <g clipPath="url(#boards)">
      ...
      <path d={`M 17 36.5 A ${cr} 6 0 0 1 17 48.5 Z`} fill="#1f4fa3" stroke="#d7263d" strokeWidth={0.3} />
      <path d={`M 183 36.5 A ${cr} 6 0 0 0 183 48.5 Z`} fill="#1f4fa3" stroke="#d7263d" strokeWidth={0.3} />
